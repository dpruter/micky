(function() {
  ...
  Views.Form = (function(_super) {
    ...
    Form.prototype._onSubmit = function(e) {
      ...
      if (this.$button.hasClass('disabled')) {
        ...
        html = "<h2>" + ngettext('Please correct the following error', 'Please correct the following errors:', errors.count) + "</h2>";
        ...
        $errorList.html(html);
        $('fieldset.name').prepend($errorList);
  ...
  Views.FormField = (function(_super) {
    ...
    FormField.prototype.getErrorTip = function() {
      return this.$tooltip || (this.$tooltip = this.$(".tooltip").length ? this.$(".tooltip") : $("<div class='tooltipyo'>" + this.errorMessage + "</div>").appendTo(this.el));
    };
  ...
  Views.IsEighteenOrOlderFormField = (function(_super) {

    __extends(IsEighteenOrOlderFormField, _super);

    function IsEighteenOrOlderFormField() {
      this.valid = __bind(this.valid, this);
      return IsEighteenOrOlderFormField.__super__.constructor.apply(this, arguments);
    }

    IsEighteenOrOlderFormField.prototype.errorMessage = "You must turn 18 by the next election to register to vote.";

    IsEighteenOrOlderFormField.prototype.initialize = function() {
      var _this = this;
      IsEighteenOrOlderFormField.__super__.initialize.call(this);
      return this.$input.on("change", function() {
        if (_this.valid()) {
          return _this.hideTooltip();
        } else {
    ...
    IsEighteenOrOlderFormField.prototype.valid = function() {
      if (!this.$input.attr('checked')) {
        return false;
      }
      return true;
    ...
    return IsEighteenOrOlderFormField;

  })(Views.FormField);

  Views.IsDisclosureDisplayedFormField = (function(_super) {

    __extends(IsDisclosureDisplayedFormField, _super);

    function IsDisclosureDisplayedFormField() {
      this.valid = __bind(this.valid, this);
      return IsDisclosureDisplayedFormField.__super__.constructor.apply(this, arguments);
    }

    IsDisclosureDisplayedFormField.prototype.errorMessage = "In order to finish your registration with the state of California, you must accept the disclosures.";

    IsDisclosureDisplayedFormField.prototype.initialize = function() {
      var _this = this;
      IsDisclosureDisplayedFormField.__super__.initialize.call(this);
      return this.$input.on("change", function() {
        if (_this.valid()) {
          return _this.hideTooltip();
        } else {
    ...
    IsDisclosureDisplayedFormField.prototype.valid = function() {
      if (!this.$input.attr('checked')) {
        return false;
      }
      return true;
    ...
    return IsDisclosureDisplayedFormField;
